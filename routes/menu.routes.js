...
module.exports = function (app) {
    app.get("/api/menu/getAll", [authJwt.verifyToken, authJwt.isAdmin], controller.getAll);
    ...
    app.get("/api/menu/getRoles", [authJwt.verifyToken, authJwt.isAdmin], controller.getRoles);
};
