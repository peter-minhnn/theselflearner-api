...
module.exports = function (app) {
    app.get("/api/menu/getAll", [authJwt.verifyToken, authJwt.isLoginAdminOrMod], controller.getAll);
    ...
    app.get("/api/menu/getRoles", [authJwt.verifyToken, authJwt.isLoginAdminOrMod], controller.getRoles);
};
